...
import { Upload, FileText, AlertTriangle, CheckCircle2, X, Eye, Download, FileCheck, Clock, DollarSign } from "lucide-react";
                  ...
                  <div>
                    ...
                    <div className="grid gap-6">
                      {analysis.potential_issues.map((issue, idx) => (
                        <div key={idx} className="bg-gradient-to-br from-red-50 to-orange-50 border border-red-200 rounded-xl p-6">
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 px-8 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-green-100">Professional letter ready for submission</p>
              </div>
